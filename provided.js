...
let clickAudio = new Audio('audio/fnaf-open-camera-sound.mp3');
let matchAudio = new Audio('audio/boop.mp3');
let winAudio = new Audio('audio/five-nights-at-freddys-6-am.mp3')
